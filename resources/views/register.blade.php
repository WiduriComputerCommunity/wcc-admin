    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
              ...
              <div class="card my-5 shadow" style="border-radius:border-radius: 30px; !important;">

                <div class="card-header" style="border-radius:border-radius: 30px 30px 0 0; background:url('images/wccSlider.jpg');">
